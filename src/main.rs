...
<p>It is still a very nostalgic project for me since it also taught me a lot about modelling in blockbench, although it isn’t my oldest coding project, but it is the oldest one, I still have access to.</p>", "https://github.com/drachens1/Bayograde"),
            ...
            Category::new_project("WEB", &mut project_manager, CategoryId(1), vec![
                ...
                Project::new("PORTFOLIO", "project", "Portfolio is simply what I call this website, I have made it over the past week using my easyy website builder library. It is written in rust and just uses a html generator for the pages based on what I put in each category.", "https://github.com/drachens1/Portfolio"),
                Project::new("WEBSITE BUILDER", "website_builder", "Website builder is just a very easy way to add different pages in a project, it is coded in rust and pre-compresses all the pages so that it can send them off quicker. It doesn't support png's so it enforces webp which is better for the web.", "https://github.com/drachens1/EasyWebsiteBuilder2"),
            ]),
            ...
            Category::new_project("OTHER", &mut project_manager, CategoryId(3), vec![
                Project::new("YT BLOCKER", "yt", "YT-Blocker is a web extension that on firefox blocks many of the more addictive qualities of youtube. I coded it because I wanted to get more coding done and less youtube watching.", "https://github.com/drachens1/YT-Blocker"),
                ...
                Project::new("SAVE IO - JAVA", "save_io_java", "Save io is my older save io system and it uses variable integers to save memory, it is way better for smaller projects and saves allot of memory.", "https://github.com/drachens1/Bayograde2/blob/master/src/main/java/org/drachens/files/filetypes/SaveIO.java"),
