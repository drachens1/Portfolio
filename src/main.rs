...
async fn main() {
    ...
    for (id, project) in manager.project_manager.projects.iter().enumerate() {
        ...
        for picture in &project.pictures {
            website.add_page(Page::new_png_from_file(format!("/{}.png",picture), format!("pages/{}.png", picture)));
        }
    }
    ...
    let category_manager = Arc::new(CategoryManager {
        categories: vec![
            Category::new_project("Game", &mut project_manager, CategoryId(0), vec![
                ...
                Project::new_pictures("Bayograde", vec!["bayograde", "bayograde_factions", "bayograde_game_creation", "bayogradee_troops", "bayograde_modifiers"], "This was the main project that actually got me into coding allot, since I always loved minecraft and war games, so I thought why not make a war game in minecraft. How it works is it uses a resource pack for the models and you use many different items to control your troops, design different troop designs research and go to war with other countries. It is also coded in minestom which is basically a very lightweight server software for minecraft.", "https://github.com/drachens1/Bayograde"),
            ...
            Category::new_project("Engines", &mut project_manager, CategoryId(4), vec![
                Project::new("Simple engine", "simple_engine", "...", "https://github.com/drachens1/SimpleEngine"),
                ...
                Project::new("Civ Engine", "civ_engine", "...", "https://github.com/drachens1/CivEngine"),
                Project::new("Rust Engines (1-6)", "rust_engine", "...", "https://github.com/drachens1/RustEngine2"),
            ]),
        ],
    });
